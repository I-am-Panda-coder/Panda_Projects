...
namespace dbr_manager
{
	struct ActorPreset
	{
		...
		bool empty() const;
		bool update(f3D flags = f3D::kNone) const;
		bool apply(bool reset = false, bool a_reloadAll = false, RE::RESET_3D_FLAGS a_additionalFlags = RE::RESET_3D_FLAGS::kNone, bool a_queueReset = false, RE::RESET_3D_FLAGS a_excludeFlags = RE::RESET_3D_FLAGS::kNone) const;
		f3D get_flags() const;
