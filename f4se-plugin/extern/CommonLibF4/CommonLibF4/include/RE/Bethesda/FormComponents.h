...
namespace RE
{
	...
	{
	public:
		enum TemplateFlags : int
		{
			kFlagNONE = 0x0000,
			kFlagTraits = 0x0001,
			kFlagStats = 0x0002,
			kFlagFactions = 0x0004,
			kFlagSpellList = 0x0008,
			kFlagAIData = 0x0010,
			kFlagAIPackages = 0x0020,
			kFlagModelAnimation = 0x0040,
			kFlagBaseData = 0x0080,
			kFlagInventory = 0x0100,
			kFlagScript = 0x0200,
			kFlagDefPackList = 0x0400,
			kFlagAttackData = 0x0800,
		...
		//enum ACTOR_BASE_DATA_FLAGS
		//{
		//	kFlagFemale = 0x01,
		//	kFlagEssential = 0x02,
		//	kFlagIsPreset = 0x04, //chargen
		//	kFlagRespawn = 0x08,
		...
		enum ACTOR_BASE_DATA_FLAGS
		{
			kFlagFemale = 0x1,						// Female
			kFlagEssential = 0x2,					// Essential
			kFlagIsCharGenFacePreset = 0x4,			// Is CharGen Face Preset
			kFlagRespawn = 0x8,						// Respawn
			kFlagAutoCalcStats = 0x10,			    // Auto-calc stats
			kFlagUnique = 0x20,						// Unique
			kFlagDoesntAffectStealthMeter = 0x40,   // Doesn't affect stealth meter
			kFlagPcLevelMult = 0x80,                // PC Level Mult
			kFlagUnknown8 = 0x100,                  // Unknown 8
			kFlagCalcForEachTemplate = 0x200,       // Calc For Each Template
			kFlagUnknown10 = 0x400,                 // Unknown 10
			kFlagProtected = 0x800,                 // Protected
			kFlagUnknown12 = 0x1000,                // Unknown 12
			kFlagUnknown13 = 0x2000,                // Unknown 13
			kFlagSummonable = 0x4000,               // Summonable
			kFlagUnknown15 = 0x8000,                // Unknown 15
			kFlagDoesntBleed = 0x10000,             // Doesn't bleed
			kFlagUnknown17 = 0x20000,               // Unknown 17
			kFlagBleedoutOverride = 0x40000,        // Bleedout Override
			kFlagOppositeGenderAnims = 0x80000,     // Opposite Gender Anims
			kFlagSimpleActor = 0x100000,            // Simple Actor
			kFlagUnknown21 = 0x200000,              // Unknown 21
			kFlagUnknown22 = 0x400000,              // Unknown 22
			kFlagNoActivationHellos = 0x800000,     // No Activation/Hellos
			kFlagDiffuseAlphaTest = 0x1000000,      // Diffuse Alpha Test
			kFlagUnknown25 = 0x2000000,             // Unknown 25
		};
