...
namespace ver
{
	...
	inline constexpr std::array<char, 16> generatePluginName()
	{
		return { 'F', '4', 'N', 'i', 'N', 'o', 'd', 'e', 'M', 'a', 'n', 'a', 'g', 'e', 'r', '\0' };
	}
	...
	inline constexpr auto PROJECT = "F4NiNodeManager";

	inline const size_t UID = 'F4NI';
}
